...
from tkinter import messagebox  # Added for showing error alerts
...
class NoteManager:
    ...
    def load_notes(self):  # Load all clinical notes from CSV into a list of dictionaries
        ...
        try:
            ...
            messagebox.showerror("File Not Found", f"Cannot find notes file: {self.note_file}")
    ...
    def load_patient_visits(self):  # Load all patient visit records from CSV into a list
        ...
        try:
            ...
            messagebox.showerror("File Not Found", f"Cannot find patient data file: {self.patient_file}")
